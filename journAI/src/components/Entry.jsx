...
const Entry = () => {
  ...
  return (
    <div className="flex h-[70vh] w-[70vw] flex-col overflow-auto rounded-xl bg-white p-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-x-4">
          ...
          <Star
            ...
            color="#0F2851"
          />
          <Trash2 className="w-[20px] -ml-1" color="#FF4747"/>
        </div>
      </div>
      ...
      <div className="mb-2 mt-auto flex justify-start gap-x-4 ml-1">
