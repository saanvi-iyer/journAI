        ...
        <div className="background max-w-screen flex min-h-screen flex-col ">
          ...
          <div className="flex justify-evenly">
            ...
            <div className="flex h-[70vh] flex-col gap-y-4">
              <div
                onClick={Create}
                  className="flex min-h-10 w-full cursor-pointer items-center justify-center rounded-lg border-[1.5px]  bg-purple-plum text-center text-white hover:bg-[#7352F7] border-none"
              >
                <p>New Entry</p>
              </div>
